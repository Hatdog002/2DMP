...
namespace Photon.Pun.Demo.Asteroids
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        public void OnStartGameButtonClicked()
        {
            ...
            PlayerPrefs.Save();
            PhotonNetwork.LoadLevel("2DPlatformLevel1");
        }
        public void OnStartGameButtonClicked1()
        {
            PhotonNetwork.CurrentRoom.IsOpen = false;
            PhotonNetwork.CurrentRoom.IsVisible = false;
        ...
        public void OnStartGameButtonClicked2()
        {
            PhotonNetwork.CurrentRoom.IsOpen = false;
            PhotonNetwork.CurrentRoom.IsVisible = false;
        ...
        public void OnStartGameButtonClicked3()
        {
            PhotonNetwork.CurrentRoom.IsOpen = false;
            PhotonNetwork.CurrentRoom.IsVisible = false;
        ...
        public void OnStartGameButtonClicked4()
        {
            PhotonNetwork.CurrentRoom.IsOpen = false;
            PhotonNetwork.CurrentRoom.IsVisible = false;
